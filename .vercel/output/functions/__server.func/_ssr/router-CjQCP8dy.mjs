...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CjQCP8dy.js
var router_CjQCP8dy_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-BSB25RS-.css";
var APP_NAME = "Vijayaprathap P";
var APP_DESCRIPTION = "Senior Frontend Engineer. React, Next.js, TypeScript. Interfaces for e-commerce and AI.";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{ title: `${APP_NAME} — Senior Frontend Engineer` },
			{
				name: "description",
...
var $$splitComponentImporter = () => import("./routes-BmqJ4eVd.mjs");
...
//#endregion
export { getRouter, router_CjQCP8dy_exports as t };
